...
//title, and it should return a Object containing these two pieces of information.
...
//optional parameter to make_album() that allows you to store the number of tracks on an
...
// calling three functions and creating with different values
let album1 = make_album("Yousra", "Album title 1");

let album2 = make_album("Hassan", "Album title 2");

// calling a make_album function witj third parameter
let album3 = make_album("Hasnain", "Album title 3", 10);
